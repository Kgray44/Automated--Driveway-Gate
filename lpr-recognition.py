...
ADAFRUIT_IO_KEY = 'aio_CoZd68P4V0yuoIIGzbyytmmO1S0t'
ADAFRUIT_IO_USERNAME = 'KGray7777'
...
_cloud_token = "TkmhoFL1HnGCkZSyjmzIUAaV0vGbNoUjdkAc"
...
def do_lpr_reco(input_path, output_path):
    ...
    #camera.capture('/home/pi/Desktop/sighthound-lpr-cloud-examples/code-samples/python/image' + timestring + '.jpg')
    #sleep(1)
    ...
    #        continue
        ...
        #b = s.encode("UTF-8")
        #with open("audi-white.jpg", "rb") as img_file:
        #s = cv2.imread('orange-car.jpg')
        ##  Encode the image for sending to the API:    open('audi-white.jpg').read()
        base64_image = base64.b64encode(open(input_file, "rb").read()).decode("utf-8")#open(inputim, "rb").read())
        #base64_image = base64.encodestring.b64encode(open(file_path).read())
